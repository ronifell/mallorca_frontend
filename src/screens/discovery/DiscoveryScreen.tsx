          ...
          <View className="flex-1 items-center justify-center">
            ...
            <View className="flex-row mt-6 items-center justify-center">
              <Pressable
                ...
                className="w-16 h-16 rounded-full bg-white border border-cream-400 items-center justify-center mr-6"
              >
                <Text className="text-brand-500 text-3xl">✕</Text>
              </Pressable>
              <Pressable
                onPress={() => handleSwipe('right')}
                className="w-20 h-20 rounded-full bg-brand-500 items-center justify-center"
              >
      ...
      {matchPopup ? (
        <View className="absolute inset-0 bg-ink-900/70 items-center justify-center px-8">
          <View className="bg-cream-100 rounded-3xl p-6 w-full max-w-md items-center">
            <Text className="text-brand-500 text-5xl mb-2">♥</Text>
            ...
            <Button label={t('discovery.sayHi')} onPress={openChat} fullWidth />
            <View className="h-2" />
            <Button
